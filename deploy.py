    ...
    if request.method == 'POST':
        ...
        for uploaded_file in request.files.getlist('image-file'):
            if uploaded_file.filename != '':
                print(os.path.join(app.instance_path, 'uploads', secure_filename(uploaded_file.filename)))
...
def comp_engineering_ertos():
    make_subject_html.MakeSubjectHTML("comp/ertos", "Embedded & Real-Time Operating Systems")
...
def comp_engineering_ics():
    make_subject_html.MakeSubjectHTML("comp/ics", "Information & Cyber Security")
    return render_template('_'.join("comp/ics".split('/')) + ".html")

@app.route('/comp/scoa')
def comp_engineering_scoa():
    make_subject_html.MakeSubjectHTML("comp/scoa", "Soft Computing and Optimization Algorithm")
...
def civil_engineering_qsct():
    make_subject_html.MakeSubjectHTML("civil/qsct", "Quantity Surveying,Contracts and Tenders")
...
def electrical_engineering_pecd():
    make_subject_html.MakeSubjectHTML("electrical/pecd", "Power Electronic Controlled Drives")
    return render_template('_'.join("electrical/pecd".split('/')) + ".html")

@app.route('/electrical/sgp')
def electrical_engineering_sgp():
    make_subject_html.MakeSubjectHTML("electrical/sgp", "Switchgear and Protection")
...
def entc_engineering_BCS():
    make_subject_html.MakeSubjectHTML("entc/BCS", "Broadband Communication Systems")
...
def entc_engineering_VLSI():
    make_subject_html.MakeSubjectHTML("entc/VLSI", "Very-Large-Scale Integration")
...
def mech_engineering_amp():
    make_subject_html.MakeSubjectHTML("mech/amp", "Advanced Manufacturing Processes")
...
def mech_engineering_pdd():
    make_subject_html.MakeSubjectHTML("mech/pdd", "Product Design and Development")
